...
!     REDUCE COMMAND DMAP DATA
 ...
 EQUIVALENCE    (rdmap1(1,1),rdmap(1,1)),(rdmap2(1,1),rdmap(1,10)),  &
     ...
     (ptbs1(1,1),ptbs(1, 1)),(ptbs2(1,1),ptbs(1,19)),  &
     (ptbs3(1,1),ptbs(1,37)),(ptbs4(1,1),ptbs(1,55))
 ...
 DATA oct1   / 6    ,         0    ,         1  ,  &
     ...
     19    ,         0    ,        12  , 21    ,         0    ,        12  ,  &
     23    ,         0    ,         8  /
 DATA ptbs1  / 1  , 24  , 26  ,  3  ,4HNONA  ,         0  ,  0  ,  &
 ...
 DATA ptbs2  / 6  , 36  , 38  ,  3  ,4HNONA  ,         0  ,  0  ,  &
 ...
 DATA ptbs3  / 11  , 22  , 23  ,  3  ,4HNONB  ,         0  , -1  ,  &
 ...
 DATA ptbs4  / 18  , 22  , 23  ,  3  ,4HNONB  ,         0  , -1  ,  &
