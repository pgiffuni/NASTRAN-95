...
!    TRANSVERSE SHEAR ROUTINE1 FOR CTRPLT1 - DOUBLE PRECISION VERSION
 ...
 DOUBLE PRECISION, INTENT(OUT)            :: ts1(60)
 DOUBLE PRECISION, INTENT(IN OUT)         :: ts2(60)
 DOUBLE PRECISION, INTENT(IN OUT)         :: ts6(40)
 DOUBLE PRECISION, INTENT(IN OUT)         :: ts6s(40)
 DOUBLE PRECISION, INTENT(IN OUT)         :: ts7(60)
 DOUBLE PRECISION, INTENT(OUT)            :: ktr3(400)
 DOUBLE PRECISION, INTENT(IN)             :: ktr31(400)
 DOUBLE PRECISION :: gs1(4),ge1(9),be(7),ga(7),wt(7),cons(2)
 
 
 DOUBLE PRECISION :: thk,a11,a12,a13,a14,a15,a16,a21,a22,a23,a24,a25,  &
     a26,a31,a32,a33,a34,a35,a36,a37 ,   cons1,cons11,cons14
 REAL :: j11,j12,j22
 ...
 DATA  be          /0.33333333333333333333D0,0.47014206D0,  &
     0.05971588D0,0.47014206D0,0.101286505D0,0.79742699D0,  &
     0.101286505D0/, ga          /0.33333333333333333333D0,  &
     2*0.47014206D0,0.05971588D0,2*0.101286505D0,0.79742699D0/,  &
     wt          /0.1125D0,3*0.066197075D0,3*0.06296959D0/
