...
!*******
 ...
 REAL, INTENT(IN OUT)                     :: ten2mt
 INTEGER, INTENT(IN)                      :: nzero
 INTEGER, INTENT(IN)                      :: iortho
 DOUBLE PRECISION, INTENT(IN OUT)         :: vr(1)
 DOUBLE PRECISION, INTENT(IN OUT)         :: vl(1)
 DOUBLE PRECISION, INTENT(IN)             :: v1(1)
 DOUBLE PRECISION, INTENT(IN)             :: v1l(1)
 DOUBLE PRECISION, INTENT(OUT)            :: v2(1)
 DOUBLE PRECISION, INTENT(OUT)            :: v2l(1)
 INTEGER, INTENT(IN OUT)                  :: zb(1)
 DOUBLE PRECISION :: , critf    ,otest(4) ,a(2)
 LOGICAL :: qpr      ,skip
...
!*******
 ...
 703 FORMAT(32H   reorthogonalization iteration,i3,  &
     9X,14HTARGET value =,d12.4,4X,8HERRORS =,4D12.4)
