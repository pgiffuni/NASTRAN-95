SUBROUTINE algan
 ...
 140  FORMAT (10X,24HNUMBER of streamsurfaces,6X,1H=,i3, /10X,18HNUMBER  &
     ...
     of points on surfaces  =,i3, /10X,29HNUMBER of blades in blade ro  &
     w,1X,1H=,i3, /10X,5HISTAK,25X,1H=,i3, /10X,6HIPUNCH,24X,1H=,i3, /1  &
     0X,5HISECN,25X,1H=,i3,/,10X,6HIFCORD,24X,1H=,i3, /10X,6HIFPLOT,24X  &
 ...
 160  FORMAT (/10X,6HZINNER,24X,1H=,f8.4, /10X,6HZOUTER,24X,1H=,f8.4, /  &
     10X,5HSCALE,25X,1H=,f8.4, /10X,6HSTACKX,24X,1H=,f8.4, /10X,6HPLTSZ  &
     e,24X,1H=,f8.4, //20X,36HSTREAMSURFACE geometry specification)
 lnct = 30
 DO  i = 1,nstns
