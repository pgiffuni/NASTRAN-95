...
!     TO SET UP FOR ISOPARAMETRIC SHELL ELEMENTS, CALLED ONLY BY SHHMGS
...
!           AVGTHK   - AVERAGE THICKNESS OF THE ELEMENT
 ...
 REAL, INTENT(OUT)                        :: egpdt(4,8)
 REAL, INTENT(OUT)                        :: dgpth(8)
 REAL, INTENT(OUT)                        :: gpnorm(4,8)
 REAL, INTENT(OUT)                        :: epnorm(4,8)
 ...
 REAL, INTENT(IN)                         :: teb(9)
 REAL, INTENT(IN)                         :: tub(9)
 REAL, INTENT(OUT)                        :: cente(3)
 REAL, INTENT(OUT)                        :: avgthk
 REAL, INTENT(IN OUT)                     :: tce(63)
 INTEGER, INTENT(IN OUT)                  :: elid
 LOGICAL :: quad
 INTEGER :: ksil(8),kcid(8),
 REAL :: temtem(8), tgrid(4,8),  tmpthk(8)
 REAL :: cent(3), ggu(9),ggn(9), teu(9),smax,smin,sl(3),gge(9), cc,  &
      x31,y31,x42,y42,exi,exj, aa,bb,ugpdm(3,8)
...
!     FROM THE BASIC COORD. SYSTEM TO THE ELEMENT COORD. SYSTEM
 ...
 500 iflag = 0
 IF (mm == 4) CALL q4nrms (bgpdt,gpnorm,iorder,iflag)
