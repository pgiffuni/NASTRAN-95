SUBROUTINE alg08
 ...
 DIMENSION xx1(21),dladm(21),dsdm(21),drvwdm(21),dl(21),dsdl(21),dp  &
     hidl(21),fx1(21),fx2(21),vvold(21),afun(20),bfun(20),hs(20),xm2(20  &
     ),vmmax(21),dvmdvm(20),teip1(21),tbip1(21)
 ...
 END DO
 IF(ipass == 1.OR.ndata(i) == 0.OR.neqn == 1.OR.nwork(i) /= 0.OR.nw  &
     ork(i+1) == 0)GO TO 390
 l1=ndimen(i)+1
 SELECT CASE ( l1 )
   CASE (    1)
 ...
 DO  j=1,nstrms
   ...
   422   FORMAT(5X,4HPASS,i3,9H  station,i3,12H  streamline,i3,40H  limitin  &
       g meridional velocity squared =,e12.5)
   424   x1=6250000.0
 ...
 DO  j=1,itub
   ...
   GO TO 562
   570   bfun(j)=bfun(j)+x7*(dsdm(j)+dsdm(j+1))*x3*(1.0-x1*(x6-1.0))/(1.0-x 1)
 END DO
