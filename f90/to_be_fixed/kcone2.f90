...
!     FIED FURTHER UNTIL FORMULATION VERIFICATION IS COMPLETED)
 ...
 kqx(1, 7) = kqx(1, 7) + cp*n*(sp*(d33*(+3.0E0*sp*i24-6.0E0*i13)  &
     + d22*i13*(-2.0E0)) - 2.0E0*d12*i02 + d22*n**2*i24)
 kqx(1, 8) = kqx(1, 8) + cp*n*(sp*(d33*(+3.0E0*sp*i34-9.0E0*i23)  &
     + d22*i23*(-3.0E0)) - 6.0E0*d12*i12 + d22*n**2*i34)
 ...
 kqx(2, 2) = kqx(2, 2) + cp*cp*(d33*(sp*(i13*(-4.5E0)  &
     + sp*i24*2.25E0) + i02*2.25E0) + d22*n*n*i24)
...
!     THE FOLLOWING CODES WERE MOVED HERE FROM KCONEY
 ...
 kqx(2,10) = kqx(2,10) + n*(d33*(h12*(-i01+sp*i12+n*h1ten*i02)  &
     + cp*h1ten*(+1.5E0*sp*i13-1.5E0*i02)) + d22*sp*(+cp*h1ten*i13+h12*i12))  &
 ...
 kqx(3, 5) = kqx(3, 5) + n*n*(d33*(h13*(+2.0E0*sp*i03+h15*i02)  &
     + cp*h15*i03*(-5.0E-1)) + d22*sp*h13*i03) + d22*sp*sp*h13*h15*i02
 kqx(3, 6) = kqx(3, 6) + h13*(sp*(d22*(sp*i02*(-1.e0+h16)+n*n*i13)  &
     + d33*n*n*i13*2.0E0) + d33*n*n*i02*(-2.0E0+h16))  &
 ...
 kqx(3,10) = kqx(3,10) + n*(d33*(h13*(-i01+sp*i12+n*h1ten*i02)  &
     + cp*n*h1ten*i03*(-5.0E-1))+d22*sp*h13*i12) + d22*sp*sp*h13*h1ten*i02
 kqx(4, 4) = kqx(4, 4) + h14*(d33*n*n*(cp*i13*(-1.0E0)+h14*i02)  &
     + d22*sp*sp*h14*i02)
 kqx(4, 5) = kqx(4, 5) + n*n*(d33*(h14*(+2.0E0*sp*i03+h15*i02)  &
     + cp*h15*i13*(-5.0E-1)) + d22*sp*h14*i03) + d22*sp*sp*h14*h15*i02
...
!     THE FOLLOWING CODES, THRU 270, WERE MOVED HERE FROM KCONEZ
 ...
 kqx(4,10) = kqx(4,10) + n*(d33*(h14*(-i01+sp*i12+n*h1ten*i02)  &
     + cp*n*h1ten*i13*(-5.0E-1)) + d22*sp*h14*i12) + d22*sp*sp*h14*h1ten*i02
 ...
 kqx(5, 6) = kqx(5, 6) + sp*(d22*(h15*(sp*i02*(-1.e0+h16)+n*n*i13)  &
     + n*n*h16*i03) + d33*n*n*(+2.0E0*h16*i03+2.0E0*h15*i13))  &
 ...
 kqx(5, 9) = kqx(5, 9) + sp*(n*(d22*(+n*h19*i03+h15*i02)  &
     + d33*(+2.0E0*n*h19*i03+h15*i02)) + d22*sp*h15*h19*i02) + d33*n*n*h15*h19*i02
 kqx(5,10) = kqx(5,10) + n*(d33*(h15*(-i01+sp*i12+n*h1ten*i02)  &
     + sp*n*h1ten*i03*2.e0) + d22*sp*(+n*h1ten*i03+h15*i12))  &
     + d22*sp*sp*h15*h1ten*i02
 kqx(6, 6) = kqx(6, 6) + h16*(sp*(d22*(sp*i02*(-2.0E0+h16)  &
     + n*n*i13*2.0E0) + d33*n*n*i13*4.0E0) + d33*n*n*i02*(-4.0E0+h16))
 kqx(6, 7) = kqx(6, 7) + sp*(d22*(sp*(h16*(-2.0E0*i12+h17*i02)  &
     + h17*i02*(-1.0E0)) + n*n*(+h17*i13+h16*i23))  &
     + d33*n*n*(+2.0E0*h17*i13 + 2.0E0*h16*i23)  &
     + d12*h16*i01*(-2.0E0))+d33*n*n*(h16*(-4.0E0*i12  &
     + h17*i02)  + h17*i02*(-2.0E0))
 kqx(6, 8) = kqx(6, 8) + sp*(d22*(sp*(h16*(-3.0E0*i22+h18*i02)  &
     + h18*i02*(-1.0E0)) + n*n*(+h18*i13+h16*i33))  &
     + d33*n*n*(+2.0E0*h18*i13 + 2.0E0*h16*i33)  &
     + d12*h16*i11*(-6.0E0)) + d33*n*n*(h16*(-6.0E0*i22  &
     + h18*i02)  + h18*i02*(-2.0E0))
 kqx(6, 9) = kqx(6, 9) + sp*(d22*(h19*(sp*i02*(-1.e0+h16)+n*n*i13)  &
     + n*h16*i02)+ d33*n*(+2.0E0*n*h19*i13+h16*i02))  &
     + d33*n*n*h19*i02*(-2.0E0+h16)
 kqx(6,10) = kqx(6,10) + n*(d33*(n*h1ten*(i02*(-2.0E0+h16)  &
     + sp*i13*2.0E0) + h16*(-i01+sp*i12)) + d22*sp*(+n*h1ten*i13+h16*i12))  &
     + d22*sp*sp*h1ten*i02*(-1.0E0+h16)
 kqx(7, 7) = kqx(7, 7) + h17*(sp*(d22*(sp*(i12*(-4.0E0)+h17*i02)  &
     + n*n*i23*2.0E0) + d12*i01*(-4.0E0)+d33*n*n*i23*4.0E0)  &
     + d33*n*n*(i12*(-8.0E0)+h17*i02))
 kqx(7, 8) = kqx(7, 8) + sp*(d22*(sp*(h17*(-3.0E0*i22+h18*i02)  &
     + h18*i12*(-2.0E0)) + n*n*(+h18*i23+h17*i33))  &
     + d12*(-6.0E0*h17*i11-2.0E0*h18*i01)  &
     + d33*n*n*(+2.0E0*h18*i23 + 2.0E0*h17*i33))  &
 ...
 kqx(7,10) = kqx(7,10) + sp*(h1ten*(d22*(sp*(+h17*i02-2.0E0*i12)  &
     + n*n*i23)  - 2.0E0*d12*i01 + 2.0E0*d33*n**2*i23)  &
     + n*h17*i12*(+d22+d33))+d33*n*(n*h1ten*(-4.0E0*i12  &
     + h17*i02)  + h17*i01*(-1.0E0))
 kqx(8, 8) = kqx(8, 8) + h18*(sp*(d22*(sp*(i22*(-6.0E0)+h18*i02)  &
     + n*n*i33*2.0E0) + d12*i11*(-1.2E01)+d33*n*n*i33*4.0E0)  &
 ...
 kqx(8,10) = kqx(8,10) + sp*(h1ten*(d22*(sp*(+h18*i02-3.0E0*i22)  &
     + n*n*i33)  - 6.0E0*d12*i11 + 2.0E0*d33*n**2*i33)  &
     + n*h18*i12*(+d22+d33)) + d33*n*(n*h1ten*(-6.0E0*i22  &
     + h18*i02)  + h18*i01*(-1.0E0))
 ...
 kqx(10,10)= kqx(10,10)+ h1ten*(n*(d33*(sp*i12*2.0E0+i01*(-2.0E0)  &
     + n*h1ten*i02) + d22*sp*i12*2.0E0)+d22*sp*sp*h1ten*i02)
