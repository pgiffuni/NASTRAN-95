...
!   PLA4
 ...
 COMMON /pla42s/ dummy(100),sum(36),stemp(9),d1(3),d2(3),a1(3),  &
     a2(3),a3(3),a4(3),ivec(3),jvec(3),kvec(3),vecl,h,v(8),ecptsa(36),  &
     st(3),ncoord,npoint,nsub1,nsub2,nsub3,t(9),cosang,sinang,u1,u2,  &
     theta, dumy(85)
 ...
 EQUIVALENCE (r(1),ivec(1)),(ngrid(1),ecptsa(2)),  &
     (coord(1),ecptsa(10))  ,  (s(1),ph1out(10))
