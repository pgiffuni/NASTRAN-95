...
!     ECPT(25) = ELEMENT TEMP       REAL
 ...
 REAL :: l1,l2,ks,khi, ivect,jvect,kvect
 DIMENSION       m(9),requiv(9),g(36),tite(10),v(25),hq(12),  &
     temp15(15),prod15(15),necpt(25),v1(3),v2(3),v3(3)
 COMMON /condas/ consts(5)
 COMMON /trimex/ ecpt(100)
 COMMON /ssgwrk/ a(45),t(9),s(18),hinv(36),prod12(12),d1(3),d2(3),  &
     habc(18),ssum(60),r(2,4),ivect(3),jvect(3),  &
     kvect(3),vv1(2),vv2(2),xsubb,xsubc,ysubc,e(18),  &
     temp,l1,l2,c1,c2,s1,s2,x1,x2,y1,y2,npoint,dum9,  &
     temp1,temp2,prod9(9),temp9(9),dum8,km,subsca,  &
     subscb,subscc,dum11,theta,nsubc,ising,u1,u2,  &
     sinang,cosang,dum10,xc,yc,determ,dum12(4)
 COMMON /matin / matid,inflag,eltemp,stress,sinth,costh
 COMMON /ssgtri/ d(9),khi(5),ks(30),p(5)
 COMMON /zzzzzz/ z(1)
 EQUIVALENCE     (consts(4),degra),(prod15(1),prod9(1)),  &
     (requiv(1),r(1,1)),(necpt(1),ecpt(1)), (v1(1),ecpt(14)),(v2(1),ecpt(18)),  &
     (v3(1),ecpt(22)),(tite(1),a(1)), (v(1),prod12(1)),(hq(1),a(1))
