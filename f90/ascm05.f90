...
!     SOLVE COMMAND DMAP DATA
 ...
 INTEGER :: comnd(6,1),subnam(2),rdmap(18,28),rdmap_1(18,9),  &
           rdmap_2(18,9),rdmap_3(18,9),rdmap_4(18,1),oct(3,5),  &
            oct_1(3,5),ptbs(7,20),ptbs_1(7,18),ptbs_2(7,2)
 ...
 EQUIVALENCE     (rdmap_1(1,1),rdmap(1, 1)),(oct_1(1,1),oct(1,1)),  &
               (rdmap_2(1,1),rdmap(1,10)),(ptbs_1(1,1),ptbs(1,1)),  &
               (rdmap_3(1,1),rdmap(1,19)),(ptbs_2(1,1),ptbs(1,19))  &
              ,(rdmap_4(1,1),rdmap(1,28))
 DATA comnd   / 4HSOLV    , 28    ,  0    ,  5    , 20    , 14  /
 DATA slash   /  1H/       /
 DATA rdmap_1 / 4HALTE,4HR   ,4H  (g,4HP1) ,4H$   ,13*4H    ,  &
 ...
 DATA rdmap_2 / 4HALTE,4HR   ,4H  (p,4HLOT),4H $  ,13*4H    ,  &
 ...
 DATA rdmap_4 / 4HALTE,4HR   ,4H  (s,4HDR2),4H $  ,13*4H            /
 DATA oct_1   / 18    ,         0    ,         1  ,  &
     19    ,         0    ,         2  , 21    ,         0    ,         1  ,  &
     22    ,         0    ,         2  , 23    ,         0    ,         2  /
 DATA ptbs_1  / 1  , 11  , 11  ,  5  ,     1  ,         0  ,  0  ,  &
