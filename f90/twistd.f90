...
!     ECPT(25)  -  TEMPEL         ELEMENT TEMPERATURE
 ...
 DOUBLE PRECISION :: cepx,cepy,ke(144),kout(144),me(144),mout(144),  &
     vleft(6),a,b,c,a2,b2,c2,vright(6),p(4),t,c23,  &
     nuc,g,e,x1,y1,x2,y2,x3,d2,a3,b3,c3,d3,y3,x4,y4,  &
     cep1,temp,cep2,ep,d,xp,yp,xl,xq,a4,b4,c4,d4,  &
     a5,b5,c5,d5,term,term1,term2,term3,term4,term5,  &
     f,z,vd1(3),vd2(3),vkn(3),vk(3),v12(3),v41(3),  &
     vp12(3),vi(3),vj(3),avec(4),smallu(4),smallv(4), xl13,xl24,con,ti(9)
...
!     CALL FATAL ERROR MESSAGE.
 ...
 IF (y3 <= 0.) GO TO 7780
 IF (y4 <= 0.) GO TO 7800
 IF (x3 <= y3*x4/y4) GO TO 7810
 IF (x4 >= x2-(x2-x3)*y4/y3) GO TO 7790
