...
!     MESAGE - ERROR MESSAGE WRITER
 ...
 COMMON /sma1dp/  kij(36),c(18),e(9),tempar(27),ti(9),temp,  &
     xsubb,xsubc,ysubc,vol,reelmu,delta,flamda,theta, ka,npoint,nsave,dummy(382)
 COMMON /hmtout/  matbuf(4)
 EQUIVALENCE      (consts(4),degra),(g(1),tempar(19)),  &
     (ecpt(1),mecpt(1),necpt(1))
