...
!     LSYS78 = .TRUE. IF KSYS78 = 0, OR 2
 ...
 DOUBLE PRECISION :: za,aki,akt,acurl,d(81),ak(81),akj,  &
     gababq(9,9),r(3),z(3),ee(63),teo,delint(12),  &
     delm(12),bmass(9,9),akm(81),akjm(81),amt(9),  &
     z1,z2,z3,pi,twopi,degrad,zmin,aa,c1,c2,c3, cosg,sing,er,et,ez,vro,voz,vzr,  &
     gor,gzo,grz,vor,vzo,vrz,del,dkl,c4,s2,s4,dgamr,  &
     ajho,ajjho,rhod,dgamar,convm,area,c2s2,  &
     acurp1(27),acurp2(9),akuph(27),akph2(9),akip(9),  &
     gababp(3,3),d1(27),d2(9),consts
...
!     FORM THE ELEMENT STIFFNESS MATRIX IN FIELD SYSTEM
 ...
 acurl(21) = (ee(15) + ajjho*ee(29))*delint(3) +  &
     ee(22)*delint(6) + 2.*ee(16)*delint(5)
...
!     ERROR EXITS
 ...
 7770 i = 37
 7777 IF (idel1 == idel2) GO TO 7778
 idel2  = idel1
 ics(1) = idel1
 ics(2) = jax
