...
!     ECPT(25)  -  TEMPEL         ELEMENT TEMPERATURE
 ...
 REAL :: ke(144),kout(144),me(144),mout(144),  &
     vleft(6),vright(6),ti(9),p(4), vd1(3),vd2(3),vkn(3),vk(3),v12(3),v41(3),  &
     vp12(3),vi(3),vj(3),avec(4),smallu(4),smallv(4)
