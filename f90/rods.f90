...
!     17            TBAR      AVERAGE ELEMENT TEMPERATURE
 ...
 REAL :: jfact    ,mu       ,kcon     ,est(200) ,k        ,  &
     evect(3) ,el       ,ke       ,me       ,te       ,  &
     ha(3)    ,hb(3)    ,kha(3)   ,khb(3)   ,ta(9)    , tb(9)    ,scale
 REAL :: massii(9),massjj(9),massij(9),massji(9),mijdum(9), mjidum(9)
...
!     THE MASS MATRIX TERMS ARE CALCULATED HERE.
 ...
 220 IF (kmbgg(2) == 0 .OR. me == 0.0) RETURN
 dict(3) = 6
 dict(4) = 7
 dict(5) = 0
