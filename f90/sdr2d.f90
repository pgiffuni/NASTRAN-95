...
589 IF (ugv_vec <= nvects .AND. symflg == 0) GO TO 210
GO TO 620
...
590 jlist = jlist + 2
IF (jlist <= nlist .AND. ugv_vec <= nvects) GO TO 210
kfrq  = 0
jlist = ilist
DO  i = ilist,nlist,2
  z(i+1) = 0
END DO
IF (ugv_vec <= nvects) GO TO 190
GO TO 620
