...
!     SOLVE COMMAND DMAP DATA FOR DYNAMIC ANALYSIS
 ...
 DATA rdmap1  / 4HALTE,4HR   ,4H  (g,4HP1) ,4H$   ,13*4H    ,  &
 ...
 DATA rdmap2  / 4HALTE,4HR   ,4H  (p,4HLOT),4H $  ,13*4H    ,  &
 ...
 DATA rdmap3  /  &
     ...
     4H    ,8*4H         /
 DATA rdmap4  / 4HLABE,4HL   ,4H  lb,4H2B $,14*4H    ,  &
 ...
 DATA rdmap5  /  &
     ...
     4H    ,8*4H         /
 DATA rdmap6  / 4HALTE,4HR   ,4H  (s,4HDR2),4H $  ,13*4H    ,  &
 ...
 DATA ptbs2  / 31  , 16  , 18  ,  3  ,4HNANO  ,         0  ,  0  ,  &
