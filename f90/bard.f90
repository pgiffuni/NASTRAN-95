...
!     ECPT(42)  -  ELTEMP         AVG. ELEMENT TEMPERATURE
 ...
 DOUBLE PRECISION :: const,bl22,blsq3,fm,ke,kk,kep,m,mep,me,  &
     lr1,lr2,lb,l2b3,l2b6,veci(3),vecj(3),veck(3),  &
     smalvn,ta,tb,vec,dela,delb,fl,smallv(3),  &
     fll,bl,blsq,blcube,ei1,ei2,r1,r2,sk1,sk2,  &
     sk3,sk4,ael,gjl,beta,bl13,blsq4,a2b,limit, epsi,epsi2
 CHARACTER (LEN=25) :: uwm
 CHARACTER (LEN=23) :: ufm
 COMMON /xmssg /  ufm,uwm
 COMMON /system/  ksystm(100)
 COMMON /emgest/  ielid,isilno(2),smalv(3),icssv,ipinfl(2),za(3),  &
     zb(3),imatid,a,i1,i2,fj,nsm,fe,c1,c2,d1,d2,  &
     f1,f2,g1,g2,k1,k2,i12,mcsida,gpa(3),mcsidb, gpb(3),tempel
...
!     (DEFAULT IS 15 PERCENT, KSYSTM(87) WORD)
 ...
 IF (DABS(fl-a2b)/a2b <= limit) GO TO 170
...
!     **                                    **
 ...
 ke(141) = -lb
 ke(143) = -l2b3
 303 GO TO k_or_m, (305,640,465,750)
