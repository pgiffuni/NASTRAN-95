...
!           EPSLNT - ARRAY OF THERMAL STRAINS FOR THE LAMINATE
 ...
 DOUBLE PRECISION, INTENT(IN)             :: tgrad
 DOUBLE PRECISION, INTENT(IN)             :: thetae
 DOUBLE PRECISION, INTENT(OUT)            :: ftherm(6)
 DOUBLE PRECISION, INTENT(IN OUT)         :: epslnt(6)
 ...
 DOUBLE PRECISION :: minrt,abbd(6,6),stiff(36),glay(9),glayt(9),  &
