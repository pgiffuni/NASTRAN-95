...
!     FORCE VECTOR IS NOW COMPLETE
 ...
 i1 = ii*2 + 9
 i2 = i1 + 1
 z1_ovr_i = -12.0*ph1out(i1)/ph1out(7+ii)**3
 z2_ovr_i = -12.0*ph1out(i2)/ph1out(7+ii)**3
 GO TO 25
 24 zi_ovr_i = -1.5/ph1out(17)**2
 z2_ovr_i = -z1_ovr_i
 25 CONTINUE
 ii1 = (ii-1)*6
 ...
 26 sig_x__1 = forvec(ii1+2)*z1_ovr_i - sdelta(1)
 sig_y__1 = forvec(ii1+3)*z1_ovr_i - sdelta(2)
 sig_xy_1 = forvec(ii1+4)*z1_ovr_i - sdelta(3)
 
 k1 = 1
 ASSIGN 27 TO iretrn
 GO TO 170
 
 27 sig_x__2 = forvec(ii1+2)*z2_ovr_i - sdelta(1)
 sig_y__2 = forvec(ii1+3)*z2_ovr_i - sdelta(2)
 sig_xy_2 = forvec(ii1+4)*z2_ovr_i - sdelta(3)
