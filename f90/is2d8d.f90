...
!     DOUBLE PRECISION VERSION
 ...
 DOUBLE PRECISION :: g(9),     xi(8),    eta(8),   tb(9),  &
     ...
     xjb(4),   xxjb(2,2),pt(3),    h(3),     bij,  &
     kij,      mij,      determ,   dumarg,   drho,  &
     dc,       dhh,      term,     thick,    savm(36), z
...
!     EACH GRID POINT
     ...
     DO  n = 1,4
       IF (kmbgg(2) /= 0) dn(n) = .25D0*(1.d0+pt(iii)*xi(n))*  &
           (1.d0+pt(jjj)*eta(n))*(pt(iii)*xi(n)+pt(jjj)*eta(n)-1.d0)
     ...
     DO  n = 5,7,2
       IF (kmbgg(2) /= 0) dn(n) = .5D0*(1.d0-pt(iii)*pt(iii))*  &
           (1.d0+pt(jjj)*eta(n))
     ...
     DO  n = 6,8,2
       IF (kmbgg(2) /= 0) dn(n) = .5D0*(1.d0+pt(iii)*xi(n))*  &
           (1.d0-pt(jjj)*pt(jjj))
...
!     EACH GRID POINT
     ...
     DO  n = 1,4
       IF (kmbgg(3) /= 0) dn(n) = .25D0*(1.d0+pt(iii)*xi(n))*  &
           (1.d0+pt(jjj)*eta(n))*(pt(iii)*xi(n)+pt(jjj)*eta(n)-1.d0)
       dnxi(n)  = .25D0*xi(n)*(1.d0+pt(jjj)*eta(n))*  &
           (2.d0*pt(iii)*xi(n)+pt(jjj)*eta(n))
       dneta(n) = .25D0*eta(n)*(1.d0+pt(iii)*xi(n))*  &
     ...
     DO  n = 5,7,2
       IF (kmbgg(3) /= 0) dn(n) = .5D0*(1.d0-pt(iii)*pt(iii))*  &
           (1.d0+pt(jjj)*eta(n))
       dnxi(n)  = -pt(iii)*(1.d0+pt(jjj)*eta(n))
       dneta(n) = .5D0*(1.d0-pt(iii)*pt(iii))*eta(n)
     END DO
     ...
     DO  n = 6,8,2
       IF (kmbgg(3) /= 0) dn(n) = .5D0*(1.d0+pt(iii)*xi(n))*  &
           (1.d0-pt(jjj)*pt(jjj))
       dnxi(n)  = .5D0*xi(n)*(1.d0-pt(jjj)*pt(jjj))
       dneta(n) = -pt(jjj)*(1.d0+pt(iii)*xi(n))
     END DO
