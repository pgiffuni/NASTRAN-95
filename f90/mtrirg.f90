...
! ECPT(19) EL. TEMPERATURE FOR MATERIAL PROPERTIES       R
 ...
 COMMON   /sma2io/ dum1(10)  &
     ,                  ifmgg ,                  dum2(25)
 COMMON   /sma2cl/ dum3(2)  &
     ,                  npvt ,                  dum4(7)  &
     ,                  link(10)           ,nogo
 COMMON   /sma2et/ ecpt(19)  &
     ,                  dum5(81)
 ...
 COMMON   /matout/ e(3)               ,anu(3)  &
     ,                  rho                ,g(3)  &
     ,                  alf(3)             ,tzero
 COMMON   /sma2dp/ d(36) ,   gambq(36),     r(3) ,    z(3)  &
     ,                                      delint(8),     ak(36)  &
     ,                  aki(36),  akt(9)  &
     ,                  dgama,    zmin,     rhod,     twopi  &
     ,                  dr,  rh,  dz,  zh,  ra,  za,  area  &
...
! AND IF AREA IS SMALL THEN APPROXIMATE INTEGRALS
 ...
 DO  i = 1,3
   ...
   DO  j = 1,3
     ...
     CYCLE
     330 delint(i1) = dki(1,3,1,2,1,3,ip,iq,r,z) + dki(3,2,1,2,3,2,ip,iq,r,z)
     CYCLE
     340 CONTINUE
...
! AND IF IT EXIST APPROXIMATE INTEGRALS
 ...
 END DO
 IF (delint(3) <= delint(6)) GO TO 475
 IF (delint(8) >= delint(3)) GO TO 475
 IF (delint(8) > delint(6)) GO TO 475
 GO TO 500
 475 CONTINUE
 kode = -1
 GO TO 310
