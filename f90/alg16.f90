SUBROUTINE alg16 (ix,log1,x1,y1,x2,y2)
 ...
 my=-ymax
 WRITE (log1,20) mx,my
 20    FORMAT (20X,46HSCALES -  x  is shown times 10 TO the power of,i3,&
 ...
 DO  kline=1,55
   ...
   DO  l=2,120
     line(l)=BLANK
   END DO
   IF (kline == 7.OR.kline == 13.OR.kline == 19.OR.kline == 25&
                 .OR.kline == 31.OR.kline == 37.OR.kline == 43&
                 .OR.kline == 49) GO TO 40
   line(1)=xi
   line(121)=xi
   GO TO 80
   40    line(1)=dash
   ...
   80    DO  i=1,ix
     ...
     line(l)=symbol
   END DO
   IF (kline == 1.OR.kline == 7.OR.kline == 13.OR.kline == 19&
                 .OR.kline == 25.OR.kline == 31.OR.kline == 37&
                 .OR.kline == 43.OR.kline == 49.OR.kline == 55) GO TO 120
   WRITE (log1,110) line
   110   FORMAT (8X,121A1)
   GO TO 140
   120   ynum=yh*10.0**my
 ...
 RETURN
 170   WRITE (log1,180)
 180   FORMAT (//,35X,54HNO plot has been made because  x  OR  y  range is &
                         &zero)
