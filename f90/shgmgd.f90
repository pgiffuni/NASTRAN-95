...
!     SET THE MISC ITEMS
 ...
 130 IF (membrn .AND. m == 1) rho = DBLE(rhox)
...
!     LOOP IS DONE, CHECK FOR ALL ZEROES FOR SHEAR MATERIAL
 ...
 600 IF (g(19) /= 0.0D0 .OR. g(20) /= 0.0D0 .OR. g(21) /= 0.0D0 .OR.  &
     g(22) /= 0.0D0) GO TO 610
 igobk  = 1
 m      = 2
 mid(3) = 0
 shrflx = .false.
