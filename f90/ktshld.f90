...
!     EST (52) = ELEMENT TEMPERATURE
 ...
 INTEGER :: xu(32),yu(32),xv(32),yv(32),xw(32),yw(32),  &
     rk(3),sk(3),eltype,elid,estid,dict(15),sil(6),  &
     sil1,sil2,SAVE(6),xthk(10),ythk(10),small(6)
 
!     RK AND SK ARE EXPONENTS IN THICKNESS VARIATION
 
 REAL :: j11,j12,j22,nsm,xc(6),yc(6),zc(6),ivect(3),  &
     jvect(3),kvect(3),cc(10),NAME(2)
 
!     LOCAL DOUBLE PRECISION VARIABLES
 
 DOUBLE PRECISION :: s11,s22,s13,s23,d334,d132,d232,s33,mshl(1024),  &
     rmx,rnx,rmnx,rmx1,rnx1,rmy,rny,rmny,rmy1,rny1,  &
     cmt(1296),ctm(36,36),cms(900),cm1(30,30),  &
     qks(960),cab(3),h4,h5,h6,qqq(20,20),  &
     sb1,sb2,sb3,sb4,sb5,sb6,sb7,sb8,sb9,rix,riy,rjx,  &
     rjy,rkx,rky,rlx,rly,g11,g22,kshl(1024),ksup(36),  &
     ksupt(36),qqqinv(360),q,ee,csub,csubt
 DOUBLE PRECISION :: sb10,sb11,sb12,sb13,sb14,sb15,sb16,sb17,sb18,sb19  &
     ...
     ,                sb40,sb41,degra,determ
 DOUBLE PRECISION :: trand(9),balotr(36),ksub(6,6),ksubt(6,6),  &
     st,d13,d22,d11,d12,d23,d33,  &
     g13,g23,g33,g12,rho,st1,a2sq,a3sq,area,vol,a1sq,  &
     st11,st22,st121,st122,st131,st132,st133,st231, st232,st233,st331,st332
 ...
 EQUIVALENCE     (a ,dista), (b  ,distb), (c ,distc),  &
     (cmt(1),ctm(1,1))      , (iest(1),est(1))
 EQUIVALENCE     (cmt(1),kshl(1),mshl(1), qqq(1,1)),  &
     (ksub(1,1),ksup(1))    , (ksubt(1,1),ksupt(1)), (qks(1),cmt(1025))
 EQUIVALENCE     (thk1,tbend1), (thk2,tbend3), (thk3,tbend5),  &
     (cm1(1,1),cms(1)), (ksystm(2),ioutpt), (ind(1,1),INDEX(1,1))
   ...
   DO  j = i,32
     ...
     DO  k = 1,3
       ...
       st = st   + sb1  + sb2  + sb4  + sb5  + sb7  + sb8  + sb9  + sb10  &
           + sb11 + sb12 + sb13 + sb15 + sb16 + sb18 + sb19 + sb20 + sb21  &
           + sb22 + sb23 + sb24 + sb26 + sb27 + sb28 + sb29 + sb30 + sb31  &
           + sb32 + sb33 + sb34 + sb36 + sb37 + sb38 + sb39 + sb40 + sb41
       IF (unimem) EXIT
     END DO
     190 CONTINUE
     200 CONTINUE
