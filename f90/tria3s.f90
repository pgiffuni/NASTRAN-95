...
!     FETCH MATERIAL PROPERTIES
 ...
 CALL shgmgs (*1130,elid,tem,mid,ts,noalfa,gi,rho,gsube,tsub0, egnor,alpha)
...
!     INITIALIZE FOR THE MAIN INTEGRATION LOOP
 ...
 160 needm = mgg1 /= 0 .AND. (nsm > 0.0 .OR. rho > 0.0)
