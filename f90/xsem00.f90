SUBROUTINE xsem00
    ...
    INTEGER :: andf ,databf,errflg,fist  ,fistnm,fstrst,opntr  &
              ...
              ,vps  ,vparml,typecd,vpsx  ,wordb ,worde ,plotf, &
              exit  ,sysbuf,subnam(2)
    ...
    COMMON /sem   / mask  ,mask2 ,mask3 ,linknm(15)   &
           /system/ sysbuf,xx(20),linkno,xxx(16),nbpc,&
                    nbpw,ncpw,xxxx(53) ,isperlnk      &
    ...
    INTEGER :: error_id
    INTEGER :: nin, nout
    CHARACTER (LEN=80) :: proj,ft05,ft06,output,infile
    !*****
