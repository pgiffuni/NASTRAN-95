...
!     EST(38) TO EST (43) = ELEMENT TEMPERATURES AT SIX GRID POINTS
 ...
 INTEGER :: xu(12),yu(12),xv(12),yv(12),eltype,elid,estid,  &
     dict(11),sil(6),sil1,sil2,SAVE(6),rk(3),sk(3),  &
     ind(6,3),NAME(2),nl(6),pi,qi,pj,qj,pimj,pinj,  &
     pipj,piqj,qimj,qinj,qipj,qiqj,ics(6),iest(45)
 REAL :: nsm,cc(3),ivect(3),jvect(3),kvect(3),xc(6),yc(6), zc(6),f(6,6)
 DOUBLE PRECISION :: gk11(6,6),gk12(6,6),gk22(6,6),ktrmg(324),  &
     gkt(12,12),krt(9),krt1(9),ktrm(12,12),q(6,6),  &
     e(6),trand(9),balotr(9),qinv(36),gktrm(12,12),  &
     st,st1,ktr1(3,3),g11,g12,g13,g22,g23,g33,  &
     ksub(2,2),ksubt(3,2),ktr(3,3),rho,determ
 ...
 EQUIVALENCE     (a,dista),(b,distb),(c,distc),(cc(1),c1),  &
     (cc(2),c2),(cc(3),c3),(krt(1),ktr(1,1)),  &
     (krt1(1),ktr1(1,1)),(est(1),iest(1)),  &
     (ksystm(2),ioutpt),(gkt(1,1),gktrm(1,1))
