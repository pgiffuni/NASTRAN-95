...
!     ASSUMED.
 ...
 REAL :: nu         ,kheat      ,maxar      ,dmaxar(3)  ,  &
     ...
     vn(3,2)    ,gptld(32)  ,bcd2(3)    ,jacob(3,3)
 DIMENSION        z(1)       ,s(4)       ,h(4)       ,gauss(8)   ,  &
     part(3,3)  ,tf(3,3)    ,tk(3,3)    ,sig(6)     ,  &
     str(18)    ,c(3,3)     ,gmat(36)   ,dalpha(6)  , store(45)
...
!     RZ IS OPEN CORE.  USE ONLY RZ(IZS) TO RZ(NZS).
 ...
 DATA    dtor  ,  gauss  /0.01745329251994, 0.57735026918962,  &
     0.55555555555555, 0.77459666924148,  &
     0.88888888888889, 0.34785484513745,  &
     0.86113631159405, 0.65214515486254,  &
     0.33998104358485/
