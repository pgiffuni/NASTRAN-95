...
!       RR
 ...
 mrr(22) = mrr(22) + hyq(1)*(hyq(1)*siij(3,1) + 2.0*(siij(5,1) +  &
           hyq(4)*siij(2,2))) + hyq(4)*(2.0*siij(4,2) + hyq(4)*siij(1,3))
 ...
 mrr(29) = mrr(29) + hyq(2)*(hyq(2)*siij(3,1) + 2.0*(siij(3,3) +  &
           hyq(5)*siij(2,2))) + hyq(5)*(2.0*siij(2,4) + hyq(5)*siij(1,3))
 ...
 mrr(36) = mrr(36) + hyq(3)*(hyq(3)*siij(3,1) + 2.0*(siij(2,4) +  &
           hyq(6)*siij(2,2))) + hyq(6)*(2.0*siij(1,5) + hyq(6)*siij(1,3))
