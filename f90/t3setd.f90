...
!           EDGLEN - EDGE LENGTHS
 ...
 DOUBLE PRECISION, INTENT(OUT)            :: dgpth(3)
 DOUBLE PRECISION, INTENT(OUT)            :: egpdt(4,3)
 DOUBLE PRECISION, INTENT(OUT)            :: gpnorm(4,3)
 DOUBLE PRECISION, INTENT(OUT)            :: epnorm(4,3)
 INTEGER, INTENT(OUT)                     :: iorder(3)
 DOUBLE PRECISION, INTENT(OUT)            :: teb(9)
 DOUBLE PRECISION, INTENT(IN OUT)         :: tub(9)
 DOUBLE PRECISION, INTENT(OUT)            :: cent(3)
 DOUBLE PRECISION, INTENT(OUT)            :: avgthk
 DOUBLE PRECISION, INTENT(OUT)            :: lx
 DOUBLE PRECISION, INTENT(OUT)            :: ly
 DOUBLE PRECISION, INTENT(OUT)            :: edglen(3)
 INTEGER, INTENT(IN OUT)                  :: elid
 INTEGER :: igpdt(4,3), igrid(4,3),  ksil(3)
 REAL :: bgpdt(4,3), tmpthk(3)
 DOUBLE PRECISION :: ggu(9), cc,   &
