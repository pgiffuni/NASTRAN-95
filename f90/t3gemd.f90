...
!     [AIC]  - [AA]  [C]
 ...
 DOUBLE PRECISION, INTENT(IN)             :: egpdt(4,3)
 INTEGER, INTENT(IN)                      :: iorder(3)
 DOUBLE PRECISION, INTENT(IN)             :: gb(9)
 DOUBLE PRECISION, INTENT(IN)             :: gs(4)
 DOUBLE PRECISION, INTENT(IN)             :: lx
 DOUBLE PRECISION, INTENT(IN)             :: ly
 DOUBLE PRECISION, INTENT(IN)             :: edglen(3)
 LOGICAL, INTENT(IN OUT)                  :: shrflx
 DOUBLE PRECISION, INTENT(OUT)            :: aic(18)
 DOUBLE PRECISION, INTENT(OUT)            :: jog
 DOUBLE PRECISION, INTENT(OUT)            :: jok
 DOUBLE PRECISION, INTENT(OUT)            :: k11
 DOUBLE PRECISION, INTENT(OUT)            :: k22
 
 INTEGER :: INDEX(3,3)
 DOUBLE PRECISION :: xx(3),yy(3),aa(9),h1,h2,bdum(3),  &
     determ,cosa,sina,cosb,sinb,cosc,sinc
