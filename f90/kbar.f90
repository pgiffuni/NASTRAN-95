...
!     FACTORS FOR SHEAR CORRECTION
 ...
 DOUBLE PRECISION :: ta(18)    ,tb(9)     ,smalv0(6) ,dela     ,  &
     ...
     sk3       ,sk4       ,ael       ,gjl      ,  &
     lr1       ,lr2       ,l         ,lsq      ,  &
     lcube     ,dp(8)     ,beta      ,lb       , l2b3      ,l2b6      ,dampc
...
!     SMA1 PROGRAM CONTROL PARAMETERS
 ...
 COMMON /sma1cl/  iopt4     ,k4ggsw    ,npvt      ,left     ,  &
     ...
     jmax      ,nlinks    ,link(10)  ,idetck   , dodet     ,nogo
 COMMON /sma1ht/  heat
 COMMON /sma1et/  ielid     ,isilno(2) ,smallv(3) ,icssv    ,  &
     ipinfl(2) ,za(3)     ,zb(3)     ,imatid   ,  &
     a         ,i1        ,i2        ,fj       ,  &
     nsm       ,fe        ,c1        ,c2       ,  &
     d1        ,d2        ,f1        ,f2       ,  &
     g1        ,g2        ,k1        ,k2       ,  &
     i12       ,           mcsida    ,gpa(3)   , mcsidb    ,gpb(3)    ,tempel
...
!     INPUT AND OUTPUT BLOCKS FOR SUBROUTINE MAT
 ...
 COMMON /matout/  e         ,g         ,nu        ,rho      ,  &
     alpha     ,tsubo     ,gsube     ,sigt     , sigc      ,sigs
 COMMON /hmtout/  fk
