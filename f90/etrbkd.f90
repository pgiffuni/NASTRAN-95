...
!     ******************************************************************
 ...
 DOUBLE PRECISION :: j2x2(4), g2x2(4),s(18),g(9),tjte(18),tite(18)  &
     ,                 ti(9),a,prod9,temp9,xsubb,xsubc,ysubc,dict5  &
     ,                 e,k,aout,d(9)  &
     ,                 consts,degra,temp,theta,sinth,costh,area,xbar  &
     ,                 ybar,xcsq,ycsq,xbsq,xcyc,px2,py2,pxy2,xbar3  &
     ,                 ybar3,ybar2,determ
 ...
 EQUIVALENCE (ielid,ecpt(1),necpt(1)), (d(1),g(1), a(79)) ,(g2x2(1),a(88))  &
     ,(tjte(1),a(100))   ,(tite(1),s(1),a(82))  &
