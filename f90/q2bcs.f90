...
!     ROUTINE (SINGLE-PRECISION VERSION)
 ...
 REAL, INTENT(OUT)                        :: rmat(3,5)
 REAL, INTENT(OUT)                        :: et(3,3)
 INTEGER, INTENT(OUT)                     :: ierror
 
 
 REAL :: mag   ,d12(3),g1(3) ,iarea  ,d13(3) ,grid(3,5),  &
     g2(3) ,itwoh ,d24(3),vec(3) ,g3(3)  , g5(3) ,g4(3) ,sadotb
 EQUIVALENCE (grid(1,1),g1(1)),(grid(1,2),g2(1)),(grid(1,3),g3(1)),  &
     (grid(1,4),g4(1)),(grid(1,5),g5(1))
...
!     SET PLANAR FLAG .TRUE. OR .FALSE.
 ...
 IF ((itwoh/2.0)**2/iarea <= 0.01) GO TO 80
 planar = .false.
 GO TO 90
 80 planar = .true.
