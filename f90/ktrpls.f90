...
!     ECPT(48) = ELEMENT TEMPERATURE                      REAL
 ...
 REAL :: nsm,ivect(3),jvect(3),kvect(3),f(14,14),  &
     xc(6),yc(6),zc(6),cc(10),ksup(36),ksupt(36),  &
     e(18),cmt(1296),qqq(20,20),qqqinv(360),mtr3(400),  &
     ktr3(400),csub(3,3),csubt(6,3),ts6(40),ts1(60),  &
     ts6s(40),ts2(60),ts7(60),trand(9),balotr(36), ksub(6,6),ksubt(6,6)
 ...
 EQUIVALENCE     (ksystm(2),ioutpt),(ksub(1,1),ksup(1)),  &
     (ksubt(1,1),ksupt(1)),(c1,cc(1)),(c2,cc(2)),  &
     (c3,cc(3)),(c4,cc(4)),(c5,cc(5)),(c6,cc(6)),  &
     (c7,cc(7)),(c8,cc(8)),(c9,cc(9)),(c10,cc(10)),  &
     (thk1,tmem1),(thk2,tmem3),(thk3,tmem5),  &
