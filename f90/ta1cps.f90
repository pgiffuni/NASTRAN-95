...
!          FILE EPTX.
 ...
 INTEGER :: pcomp(2),pcomp1(2),pcomp2(2),comps,pcbit(3),eptx,  &
            ...
            flag,ept,pcomps,eof,elid,pidloc,eoeloc,sym,symmem,  &
            eoe,sysbuf,pos,pos1,z,buf0,buf1,buf2,buf3,buf4,  &
            buf5,FILE,INDEX(6,3),indexx(3,3),andf,orf,BLANK

 REAL :: glay(25),gmembr(17),gbendg(17),gmembd(17),  &
         gtrshr(17),exx,eyy,eixx,eiyy,zx,zy,rpshel(17), &
         alfa1,alfa2,alfa12,tref,gsube
 REAL :: theta,thetar,c,c2,c4,s,s2,s4,pi,twopi,raddeg,  &
         degrad,t(9),GT(9),gbr(9),gbar(3,3),g(25),gd(9),  &
         gdt(9),gdbr(9),gdbar(3,3),gd2(3,3),u(9),g3i(9),  &
         g3iu(9),g3br(9),g3bar(3,3),g1(3,3),g2(3,3),  &
         g3(2,2),g4(3,3),tlam,zk,zk1,zref,zg1,zg2,zg4,zi,  &
         ti,rho,detrmn,const,zbarx,zbary,trflx(2,2),zbarxt,  &
         zbarxb,zbaryt,zbaryb,zbar(2),gtrflx(2,2),gd4(3,3),  &
         g3invd(2,2),ex,ey,e(2),fi(2),fii(2),ri(2),determ,  &
         dum(6),dummy(3),stiff(6,6),ei(2),gd1(3,3),epsi

 DIMENSION       rz(1),npcmp(3),npcmp1(3),npcmp2(3),nam(2),nam1(2),  &
                 nam2(2),matnam(3),ipcomp(7),imembr(17),ibendg(17),  &
                 imembd(17),itrshr(17),imptx(7),ieptx(7)
...
!     THE CORRESSPONDING LAYER ON THE OTHER SIDE OF SYMMETRY
   ...
   DO  ir = 1,2
     ri(ir) = (fi(ir)/e(ir) +(-zk1)*ti-ti*ti/3.0 )*fi(ir)/e(ir)  &
         + (zk1*zk1/3.0+zk1*ti/4.0+ti*ti/20.0)*ti*ti
     ri(ir) = ri(ir)*e(ir)*e(ir)*ti
   END DO
...
!     FATAL ERROR MESSAGES
 ...
 1220 FORMAT ('0*** SYSTEM FATAL ERROR.  PCOMP, PCOMP1 OR PCOMP2',  &
     ' DATA NOT FOUND BY SUBROUTINE TA1CPS.')
 nogo = 1
 GO TO 1300
 1230 CALL page2 (4)
