...
!     ECPT(35) = ELEMENT TEMPERATURE    REAL           GEOM3
 ...
 REAL :: kqn(10,10)    ,kqx(10,10)     ,kqe(10,10)     ,  &
     kqy(10,10)    ,fac(7) ,h(120) ,integ  ,kij    ,  &
     nspopi ,n     ,n2     ,nsp    ,l2     ,ncp    , n2e22  ,n2e33 ,n2d33
 ...
 COMMON /sma1dp/  sum    ,qq1   ,qq2    ,qq3    ,qq4    ,kijd(36),  &
     integ(28)     ,kij(36),huq(100)       ,hyqf(10),  &
...
!     FIED FURTHER UNTIL FORMULATION VERIFICATION IS COMPLETED)
 ...
 kqx(1, 7) = kqx(1, 7) + cp*n*(sp*(d33*(+3.0*sp*i24-6.0*i13)  &
     + d22*i13*(-2.0)) - 2.0*d12*i02 + d22*n**2*i24)
 kqx(1, 8) = kqx(1, 8) + cp*n*(sp*(d33*(+3.0*sp*i34-9.0*i23)  &
     + d22*i23*(-3.0)) - 6.0*d12*i12 + d22*n**2*i34)
 ...
 kqx(2, 2) = kqx(2, 2) + cp*cp*(d33*(sp*(i13*(-4.5)  &
     + sp*i24*2.25) + i02*2.25) + d22*n*n*i24)
 ...
 kqx(2, 6) = kqx(2, 6) + cp*n*(d33*(sp*(i13*(-6.0)  &
     + sp*i24*3.0) + i02*3.0) + d22*(-sp*i13+n**2*i24))
 kqx(2, 7) = kqx(2, 7) + cp*n*(d33*(sp*(i23*(-9.0) + sp*i34*3.0) + i12*6.0)  &
     + d22*(-2.0*sp*i23 + n**2*i34) + d12*i12*(-2.0))
 kqx(2, 8) = kqx(2, 8) + cp*n*(d33*(sp*(i33*(-12.0)  &
     + sp*i44*3.0) + i22*9.0) + d22*(-3.0*sp*i33+n**2*i44) + d12*i22*(-6.0))
 ...
 kqx(6, 6) = kqx(6, 6) + n*n*(sp*(i13*(d22*(-2.0)+d33*(-8.0))  &
     + d33*sp*i24*4.0) + d22*n**2*i24 + 4.0*d33*i02) + d22*sp*sp*i02
 kqx(6, 7) = kqx(6, 7) + n*n*(sp*(i23*(d22*(-3.0)+d33*(-12.0))  &
     + d33*sp*i34*4.0) + i12*(-2.0*d12+8.0*d33)  &
     + d22*n*n*i34) + sp*(+2.0*d12*i01+2.0*d22*sp*i12)
 kqx(6, 8) = kqx(6, 8) + n*n*(sp*(i33*(d22*(-4.0)+d33*(-16.0))  &
     + d33*sp*i44*4.0) + i22*(-6.0*d12+12.0*d33)  &
     + d22*n*n*i44)+sp*(+6.0*d12*i11+3.0*d22*sp*i22)
 kqx(6, 9) = kqx(6, 9) + n*(sp*(d33*(+2.0*sp*i13-2.0*i02)  &
     + d22*i02*(-1.0)) + d22*n*n*i13)
 kqx(6,10) = kqx(6,10) + n*(d33*(sp*(i12*(-4.0) + sp*i23*2.0)  &
     + i01*2.0)+ d22*(+n**2*i23-sp*i12))
 kqx(7, 7) = kqx(7, 7) + n*n*(sp*(i33*(d22*(-4.0)+d33*(-16.0))  &
     + d33*sp*i44*4.0) + i22*(d12*(-4.0) +d33*16.0)  &
     + d22*n*n*i44) + sp*(d12*i11*8.0+d22*sp*i22*4.0) + d11*i00*4.0
 kqx(7, 8) = kqx(7, 8) + n*n*(sp*(i43*(d22*(-5.0)+d33*(-20.0))  &
     + d33*sp*i54*4.0) + i32*(d12*(-8.0)+d33*24.0)  &
     + d22*n*n*i54) + sp*(d12*i21*18.0+d22*sp*i32*6.0) + d11*i10*12.0
 kqx(7, 9) = kqx(7, 9) + n*(sp*(d33*(+2.0*sp*i23-4.0*i12)  &
     + d22*i12*(-2.0)) - 2.0*d12*i01 + d22*n**2*i23)
 kqx(7,10) = kqx(7,10) + n*(d33*(sp*(i22*(-6.0)+sp*i33*2.0)  &
     + i11*4.0)+ d22*(+n**2*i33-2.0*sp*i22) + d12*i11*(-2.0))
 kqx(8, 8) = kqx(8, 8) + n*n*(sp*(i53*(d22*(-6.0)+d33*(-24.0))  &
     + d33*sp*i64*4.0) + i42*(d12*(-12.0) + d33*36.0)  &
     + d22*n*n*i64) + sp*(d12*i31*36.0+d22*sp*i42*9.0) + d11*i20*36.0
 kqx(8, 9) = kqx(8, 9) + n*(sp*(d33*(+2.0*sp*i33-6.0*i22)  &
     + d22*i22*(-3.0)) - 6.0*d12*i11 + d22*n**2*i33)
 kqx(8,10) = kqx(8,10) + n*(d33*(sp*(i32*(-8.0)+sp*i43*2.0)  &
     + i21*6.0)+ d22*(+n**2*i43-3.0*sp*i32) + d12*i21*(-6.0))
...
!     THE FOLLOWING CODES WERE MOVED HERE FROM KCONEY
 ...
 kqx(2,10) = kqx(2,10) + n*(d33*(h12*(-i01+sp*i12+n*h1ten*i02)  &
     + cp*h1ten*(+1.5*sp*i13 - 1.5*i02)) + d22*sp*(+cp*h1ten*i13 + h12*i12))  &
 ...
 kqx(3, 5) = kqx(3, 5) + n*n*(d33*(h13*(+2.0*sp*i03+h15*i02)  &
     + cp*h15*i03*(-0.5)) + d22*sp*h13*i03) + d22*sp*sp*h13*h15*i02
 kqx(3, 6) = kqx(3, 6) + h13*(sp*(d22*(sp*i02*(-1.+h16)+n*n*i13)  &
     + d33*n*n*i13*2.0) + d33*n*n*i02*(-2.0+h16)) + d33*cp*n*n*h16*i03*(-0.5)
...
!     THE FOLLOWING CODES, THRU 270, WERE MOVED HERE FROM KCONEZ
 ...
 kqx(4,10) = kqx(4,10) + n*(d33*(h14*(-i01+sp*i12+n*h1ten*i02)  &
     + cp*n*h1ten*i13*(-0.5)) + d22*sp*h14*i12) + d22*sp*sp*h14*h1ten*i02
 ...
 kqx(5, 6) = kqx(5, 6) + sp*(d22*(h15*(sp*i02*(-1.+h16)+n*n*i13)  &
     + n*n*h16*i03) + d33*n*n*(+2.0*h16*i03+2.0*h15*i13))  &
 ...
 kqx(5, 8) = kqx(5, 8) + sp*(h15*(d22*(sp*(-3.0*i22+h18*i02)  &
     + n*n*i33) - 6.0*d12*i11 + 2.0*d33*n**2*i33) + n*n*h18*i03*(+d22+2.0*d33))  &
     + d33*n*n*h15*(-6.0*i22+h18*i02)
 kqx(5, 9) = kqx(5, 9) + sp*(n*(d22*(+n*h19*i03+h15*i02)  &
     + d33*(+2.0*n*h19*i03+h15*i02)) + d22*sp*h15*h19*i02) + d33*n*n*h15*h19*i02
 kqx(5,10) = kqx(5,10) + n*(d33*(h15*(-i01+sp*i12+n*h1ten*i02)  &
     + sp*n*h1ten*i03*2.) + d22*sp*(+n*h1ten*i03+h15*i12))  &
     + d22*sp*sp*h15*h1ten*i02
 kqx(6, 6) = kqx(6, 6) + h16*(sp*(d22*(sp*i02*(-2.0+h16)  &
     + n*n*i13*2.0) + d33*n*n*i13*4.0) + d33*n*n*i02*(-4.0+h16))
 kqx(6, 7) = kqx(6, 7) + sp*(d22*(sp*(h16*(-2.0*i12+h17*i02)  &
     + h17*i02*(-1.0)) + n*n*(+h17*i13+h16*i23))  &
     + d33*n*n*(+2.0*h17*i13 + 2.0*h16*i23)  &
     + d12*h16*i01*(-2.0))+d33*n*n*(h16*(-4.0*i12 + h17*i02)  + h17*i02*(-2.0))
 kqx(6, 8) = kqx(6, 8) + sp*(d22*(sp*(h16*(-3.0*i22+h18*i02)  &
     + h18*i02*(-1.0)) + n*n*(+h18*i13+h16*i33))  &
     + d33*n*n*(+2.0*h18*i13 + 2.0*h16*i33)  &
     + d12*h16*i11*(-6.0)) + d33*n*n*(h16*(-6.0*i22 + h18*i02)  + h18*i02*(-2.0))
 kqx(6, 9) = kqx(6, 9) + sp*(d22*(h19*(sp*i02*(-1.+h16)+n*n*i13)  &
     + n*h16*i02)+ d33*n*(+2.0*n*h19*i13+h16*i02)) + d33*n*n*h19*i02*(-2.0+h16)
 kqx(6,10) = kqx(6,10) + n*(d33*(n*h1ten*(i02*(-2.0+h16)  &
     + sp*i13*2.0) + h16*(-i01+sp*i12)) + d22*sp*(+n*h1ten*i13+h16*i12))  &
     + d22*sp*sp*h1ten*i02*(-1.0+h16)
 kqx(7, 7) = kqx(7, 7) + h17*(sp*(d22*(sp*(i12*(-4.0)+h17*i02)  &
     + n*n*i23*2.0) + d12*i01*(-4.0)+d33*n*n*i23*4.0)  &
     + d33*n*n*(i12*(-8.0)+h17*i02))
 kqx(7, 8) = kqx(7, 8) + sp*(d22*(sp*(h17*(-3.0*i22+h18*i02)  &
     + h18*i12*(-2.0)) + n*n*(+h18*i23+h17*i33))  &
 ...
 kqx(10,10)= kqx(10,10)+ h1ten*(n*(d33*(sp*i12*2.0+i01*(-2.0)  &
     + n*h1ten*i02) + d22*sp*i12*2.0)+d22*sp*sp*h1ten*i02)
