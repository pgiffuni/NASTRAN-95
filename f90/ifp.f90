SUBROUTINE ifp
    ...
    INTEGER :: fnm(2,16),ii(16),ifle(16),STATUS(16),iblkda(2), &
               ...
               name(2),inam(2),itype(2),nentry(80),itype1(2),  &
               itype2(2)
    ...
    COMMON /ifpdta/ id,n,k,kx,ky,i(100),m(100),mf(100),m1(100),  &
                    ...
                    iaxf,naxf,lharm,knt,kslot1,kslot2,kslot3,kslot4, &
                    kslot5,gc(7),ll(6)
    ...
    DATA    kkl    / 48, 49, 50, 67, 71, 75, 68, 72, 76, 11, 10*0  ,  &
                     45, 46, 44, 41,250,260, 39, 42,121, 34, 37, 43,  &
                     31, 7*0/
